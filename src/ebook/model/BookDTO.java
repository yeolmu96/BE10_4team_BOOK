...
public class BookDTO {
    ...
    public BookDTO(int bookId, String title, String category, int price, String description, String author, int salesCount) {
        this.bookId = bookId;
        this.title = title;
        this.category = category;
        this.price = price;
    ...
    public String toString() {
        return String.format("ID:%d | [%s] by %s | %s | %,d원 | 판매:%d\n설명: %s",
            bookId, title, author, category, price, salesCount, description == null ? "" : description);
    }
}

...
public class UserDTO {
    ...
    // 전체필드 생성자 (SELECT, 조회용)
    public UserDTO(int id, String userId, String password, String name, String email,
                   LocalDateTime joinedAt, boolean isAdmin, int payBalance, int pointsBalance) {
        this.id = id;
        this.userId = userId;
        this.password = password;
        this.name = name;
    ...
    public int getPayBalance() { return payBalance; }
    public int getPointsBalance() { return pointsBalance; }

    public void setPassword(String password) { this.password = password; }
    public void setEmail(String email) { this.email = email; }
    public void setPayBalance(int payBalance) { this.payBalance = payBalance; }
